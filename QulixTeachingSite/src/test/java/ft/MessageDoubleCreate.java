...
//        Object firstMessage = messagesPage.fillMessageForm(new MessageData()
//                .withName("First message").withText("there not there").withAuthor(mainPage.getCurrentUser()));
...
//        messagesPage.initMessageCreation();
//        Object secondMessage = messagesPage.fillMessageForm(new MessageData().withName("Second message").withText("there not there").withAuthor(mainPage.getCurrentUser()));
//        messagesPage.submitMessageCreation();
//        messagesPage.isShowMessageFormDisplayed();
...
//
//
//        messagesPage.deleteTheLatestMessage(secondMessage);
//        messagesPage.deleteTheLatestMessage(firstMessage);
//
//
//    }
//}
